...
To access already existing visualizations and filters, import [export.ndjson](https://github.com/jfrog/log-analytics-elastic/blob/master/kibana/export.ndjson) to Saved objects in Management section
